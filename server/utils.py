...
def get_httpx_client(
    ...
    **kwargs,
    ...
    default_proxies.update({
        "http://": os.environ.get("http_proxy") if not os.environ.get("http_proxy") or len(os.environ.get("http_proxy").strip()) > 0 else None,
        "https://": os.environ.get("https_proxy") if not os.environ.get("https_proxy") or len(os.environ.get("https_proxy").strip()) > 0 else None,
        "all://": os.environ.get("all_proxy") if not os.environ.get("all_proxy") or len(os.environ.get("all_proxy").strip()) > 0 else None,
    })
